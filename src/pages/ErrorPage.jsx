...
const ErrorPage = () => {
    return (
        <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 lg:p-28">
            <Helmet>
                <title>Foddie | Error Occour</title>
            </Helmet>
            <motion.div
            ...
            >
                <motion.p
                    ...
                    className="text-6xl md:text-6xl lg:text-7xl font-bold tracking-wider text-neutral"
                >
                    404
                </motion.p>
                <motion.p
                    ...
                    className="text-4xl md:text-4xl lg:text-5xl font-bold tracking-wider text-neutral mt-2"
                >
                    Page Not Found
                </motion.p>
                <motion.p
                    ...
                    className="text-sm lg:text-base text-neutral my-12"
                >
